---
title: "Suunnittelu, editointi ja datan hallinta QGISillä"
author: "Gispo Oy."
date: "`r Sys.Date()`"
site: "bookdown::bookdown_site"
abstract: "Jatkokurssi datan tuottamisesta QGISissä."
output:
    bookdown::html_book:
        toc: true
        theme: null
...
::: note-box
[Kurssihakemisto.zip](https://drive.google.com/uc?export=download&id=1Npfo-AS-rIJDdy9BS0agm63AolvbjfVC)
:::
...
Nämä materiaalit on "Suunnittelu, editointi ja datan hallinta QGISillä"-kurssille kehittänyt Gispo Oy. Materiaalit on lisensoitu seuraavalla lisenssillä: [CC BY-ND 4.0](https://creativecommons.org/licenses/by-nd/4.0/)
