...
Tallenna ruudukko **Loppi-GeoPackageen** nimellä **\"Loppi_ruudukko\"**. Kun klikkaat **Suorita**, QGIS luo heksagoniruudukon valitsemallesi alueelle.

![](img/harjoitus_3/image5.png)

Kun ruudukko on luotu, valikoimme siitä vain Loppi-polygonin kohdalle osuvat ruudut. Tämä tehdään **Prosessointityökalut-paneelista Vektoritiedosta poiminta \> Valitse sijainnin perusteella -työkalulla**. Tee valinta luodusta **Loppi_ruudukko-tasosta** ja valitse ne kohteet, jotka eivät osu polygoniin (ovat erillään). Valitse **luodaan uusi valinta** ja klikkaa **Suorita**.

![](img/harjoitus_3/image6.png)

QGIS valitsee kaikki ruudut, jotka eivät osu loppi-polygoniin. Nyt poistamme kyseiset ruudut laittamalla tason muokkaus päälle kynäkuvakkeesta ![](img/harjoitus_3/image7.png) ja poistamalla valitut kohteet ![](img/harjoitus_3/image8.png).

![](img/harjoitus_3/image9.png)

Nyt meillä on ainoastaan halutut kohteet **Loppi_ruudukko-tasossamme**. Seuraavaksi lisäämme tasoon uudet attribuuttitietokentät, jotka kertovat kyseisen tason maankäytöstä. Seuraamme luokituksessa SLICES-luokitusta, jonka luemme toisesta taulusta. Luokittelu on kolmiportainen, joten ensimmäisenä luomme ominaisuustietokentän nimeltä **\"Taso_1\"** **Loppi_ruudukko-tason** attribuuttitauluun. Avaa ruudukko-tason attribuuttitaulu klikkaamalla **Avaa attribuuttitaulu -kuvaketta** ![](img/harjoitus_3/image10.png) **Ominaisuustietojen työkalupalkista** tai klikkaamalla tasoa hiiren oikealla painikkeella ja valitsemalla **Avaa attribuuttitaulu**. Luo uusi kenttä klikkaamalla **Uusi kenttä -kuvaketta** ![](img/harjoitus_3/image11.png) attribuuttitaulussa.
...
Asetetaan nyt säännöt, jonka mukaan relaatiot riippuvat lomakkeen täytössä tehdyistä valinnoista. Mene uudestaan tason **Attribuuttilomakkeeseen** ja valitsemaasi tason ominaisuuskenttään (Taso_1, Taso_2 tai Taso_3). SyötäTaso_2 -kentän **Suodatinlauseke-kenttään** seuraava lauseke:
